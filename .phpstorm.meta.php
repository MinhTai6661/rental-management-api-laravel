...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.CLIENT_URL' => 'string',
            'app.expire_register_token_hours' => 'string',
            ...
            'filesystems.links./Users/fcv-55/tainm/rental-management/rental-management-api-laravel/public/storage' => 'string',
            'horizon.name' => 'string',
            'horizon.domain' => 'NULL',
            'horizon.path' => 'string',
            'horizon.use' => 'string',
            ...
            'sanctum.models.access_token' => 'string',
            ...
            'image.options.backgroundColor' => 'string',
...
'app.aliases.View','app.aliases.Vite','app.CLIENT_URL','app.expire_register_token_hours','auth.defaults.guard',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/fcv-55/tainm/rental-management/rental-management-api-laravel/public/storage','horizon.name','horizon.domain',
...
'horizon.environments.production.supervisor-1.balanceCooldown','horizon.environments.local.supervisor-1.maxProcesses','horizon.watch','logging.default','logging.deprecations.channel',
...
'mail.reply_to.address','mail.reply_to.name','passport.guard','passport.middleware','passport.private_key',
'passport.public_key','passport.connection','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'sanctum.middleware.validate_csrf_token','sanctum.models.access_token','services.postmark.key','services.resend.key','services.ses.key',
...
'session.http_only','session.same_site','session.partitioned','session.serialization','telescope.enabled',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_status_codes','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','image.driver','image.options.autoOrientation',
'image.options.decodeAnimation','image.options.backgroundColor','image.options.strip','boost.enabled','boost.browser_logs_watcher',
...
'mcp.redirect_domains','mcp.custom_schemes','mcp.authorization_server','ide-helper.filename','ide-helper.models_filename',
...
'horizon.retry-jobs.show','horizon.jobs.show','horizon.index','sanctum.csrf-cookie','telescope','login','google.redirect',
'google.callback','register','forgot-password','reset-password','logout','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'emails.register','emails.reset_password','vendor.mail.html.button','vendor.mail.html.footer','vendor.mail.html.header',
...
'vendor.mail.text.panel','vendor.mail.text.subcopy','vendor.mail.text.table','welcome','horizon::layout',
...
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','MAIL_REPLY_TO_ADDRESS','MAIL_REPLY_TO_NAME','AWS_ACCESS_KEY_ID',
'AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME',
'CLIENT_URL','EXPIRE_REGISTER_TOKEN_HOURS','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_CALLBACK_URL',);
